...
public class BooksApi {
	...
	public Book update(@PathVariable("id") Long id, @RequestParam(value = "title") String title,
			@RequestParam(value = "description") String description, @RequestParam(value = "language") String lang,
...
// create a new class in controller to viewContoller (JSP - index.jsp)
// WEB-INF  - index.jsp
// DEPENDENCY - tomcat - jstl
// DONT FORGET TO input POM.XML
